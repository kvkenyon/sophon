...
This guide translates responsibilities, authority, and communication paths from the vendored FirstMate baseline to Parallel Intellect.
It is deliberately semantic rather than a word substitution guide.

| FirstMate term | Parallel Intellect term | Semantic migration |
|---|---|---|
...
| FirstMate | Captain | The coordinating agent becomes the captain. It plans, delegates, supervises, synthesizes evidence, and routes escalations. |
...
| SecondMate | Removed in V1 | V1 has no nested coordinator/home topology. The captain delegates directly to workers; do not emulate secondmate routing, provisioning, or independent backlogs. |
...
The captain is the operator's only agent-facing coordinator.
Workers communicate findings, completion evidence, and blockers to the captain through structured task state.
Workers do not contact the operator directly.

FirstMate's instruction that its firstmate never edits a project becomes a separation of duties: the Parallel Intellect captain plans and coordinates while the assigned worker performs project changes in its leased worktree.
...
- Say “operator” for the human and “captain” for the coordinating agent.
- Say “worker” for a delegated agent and “mission” or “mission workers” for the coordinated set.
- Present durable unresolved choices as operator signals, not “captain holds.”
- Remove nautical salutation and seasoning requirements from product-facing prompts; they are FirstMate presentation policy, not Parallel Intellect identity.
