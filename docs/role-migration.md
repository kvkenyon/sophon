...
FirstMate's instruction that its firstmate never edits a project becomes a separation of duties: the Parallel Intellect commander plans and coordinates while the assigned worker performs project changes in its leased worktree.
