...
Write the version 1 result JSON — truthful summary, verification commands and exit codes, changed files, risks, and no hidden unresolved decisions — to the result path named in the brief.
